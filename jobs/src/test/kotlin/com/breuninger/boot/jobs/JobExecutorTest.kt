...
class JobExecutorTest {
  ...
  private val jobExecutor = JobExecutor(jobRunnable, jobExecutionService, applicationEventPublisher, scheduledExecutorService,
    meterRegistry)
  ...
  @Test
  fun `ensure that JobExecutionService acquireRunLock is called on run`() {
    jobExecutor.run()
